...
//   ./gradlew shadowJar -Pmc=21   ->  BetterAntiDupe-4.5.0.jar         (1.21.x,       Java 21)
//   ./gradlew shadowJar -Pmc=26   ->  BetterAntiDupe-4.5.0-mc26.jar    (26.0 to 26.2, Java 25)
...
val mcTarget = when (mcLine) {
    ...
    "263" -> McTarget("26.3.build.19-alpha", "-mc263", "26.3", 25, "26.3")
