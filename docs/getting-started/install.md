...
* Minecraft **1.21.x**: `BetterAntiDupe-4.5.1.jar`
* Minecraft **26.0 to 26.2**: `BetterAntiDupe-4.5.1-mc26.jar`
* Minecraft **26.3**: `BetterAntiDupe-4.5.1-mc263.jar`
...
```
[BetterAntiDupe] === BetterAntiDupe v4.5.1 ===
